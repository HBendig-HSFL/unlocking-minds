...
def extract_fixations_list(gazelist, t1, t2, min_dur, report_fix):
    ...
    # Initialize fixation cluster and fixations gazelist
    fix_clust = []
    fix_clust_t2 = []
    x_t2 = []
    y_t2 = []
    ...
    if report_fix == '1':
        ...
        plt.legend(['fixation centers and their durations'], loc='best')
